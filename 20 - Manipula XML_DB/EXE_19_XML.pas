...
{                                          XML Data Binding                                           }
{                                                                                                     }
{         Generated on: 26/01/2020 21:31:55                                                           }
{       Generated from: G:\Documentos\Delphi\Mestre dos Codigos\20 - Manipula XML_DB\EXE_19_XML.xml   }
{   Settings stored in: G:\Documentos\Delphi\Mestre dos Codigos\20 - Manipula XML_DB\EXE_19_XML.xdb   }
{                                                                                                     }
{*****************************************************************************************************}
...
{ IXMLResponseType }
  ...
  IXMLResponseType = interface(IXMLNode)
    ['{D9095F5D-19BE-4D98-99CC-405B6A404421}']
    { Property Accessors }
...
{ IXML_metaType }
  ...
  IXML_metaType = interface(IXMLNode)
    ['{3A410E15-E463-4BD7-97F0-3A7C8F78BDFA}']
    { Property Accessors }
...
{ IXMLRateLimitType }
  ...
  IXMLRateLimitType = interface(IXMLNode)
    ['{3853F127-5F0A-45E1-8105-57AFBB7C749E}']
    { Property Accessors }
...
{ IXMLResultType }
  ...
  IXMLResultType = interface(IXMLNodeCollection)
    ['{092586D3-5E82-4462-942E-50BA3C49316D}']
    { Property Accessors }
...
{ IXMLItemType }
  ...
  IXMLItemType = interface(IXMLNode)
    ['{D8BD93EC-EF4A-41B9-B750-8830CF11E7F4}']
    { Property Accessors }
...
{ IXML_linksType }
  ...
  IXML_linksType = interface(IXMLNode)
    ['{CB3AE356-E5FB-49DC-BA48-2C33D9C8B94F}']
    { Property Accessors }
...
{ IXMLSelfType }
  ...
  IXMLSelfType = interface(IXMLNode)
    ['{17C5DE7E-1788-47CC-93EE-273027C950C4}']
    { Property Accessors }
...
{ IXMLEditType }
  ...
  IXMLEditType = interface(IXMLNode)
    ['{643FD8C6-3179-47E5-AD6C-615146F838EC}']
    { Property Accessors }
    function Get_Href: UnicodeString;
    procedure Set_Href(Value: UnicodeString);
    { Methods & Properties }
...
{ IXMLAvatarType }
  ...
  IXMLAvatarType = interface(IXMLNode)
    ['{9B4C931C-679C-45A2-A900-9E373A64B8A1}']
    { Property Accessors }
    function Get_Href: UnicodeString;
    procedure Set_Href(Value: UnicodeString);
    { Methods & Properties }
