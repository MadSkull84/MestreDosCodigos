...
{                                      XML Data Binding                                      }
{                                                                                            }
{         Generated on: 20/01/2020 17:50:13                                                  }
{       Generated from: G:\Documentos\Delphi\Mestre dos Codigos\19 - XML_DB\EXE_19_XML.xml   }
{   Settings stored in: G:\Documentos\Delphi\Mestre dos Codigos\19 - XML_DB\EXE_19_XML.xdb   }
{                                                                                            }
{********************************************************************************************}
...
{ IXMLResponseType }
  ...
  IXMLResponseType = interface(IXMLNode)
    ['{155E13BA-0539-4385-BF3E-6092CF180EBC}']
    { Property Accessors }
...
{ IXML_metaType }
  ...
  IXML_metaType = interface(IXMLNode)
    ['{4514129F-2415-4207-A79A-1F7839B71443}']
    { Property Accessors }
...
{ IXMLRateLimitType }
  ...
  IXMLRateLimitType = interface(IXMLNode)
    ['{A7F4943D-FEA2-492E-9E8E-EC38DE9C16D3}']
    { Property Accessors }
...
{ IXMLResultType }
  ...
  IXMLResultType = interface(IXMLNodeCollection)
    ['{7806072A-8AE4-4BC6-9946-3D88C665DEB9}']
    { Property Accessors }
...
{ IXMLItemType }
  ...
  IXMLItemType = interface(IXMLNode)
    ['{ACDCAA56-88AE-44C9-9FCF-D18BA178E1FA}']
    { Property Accessors }
...
{ IXML_linksType }
  ...
  IXML_linksType = interface(IXMLNode)
    ['{6EC37122-096D-4F0D-89E2-B934D5AD6C15}']
    { Property Accessors }
...
{ IXMLSelfType }
  ...
  IXMLSelfType = interface(IXMLNode)
    ['{5EB87EA2-F12A-49A5-9E72-0F89FB1988C7}']
    { Property Accessors }
...
{ IXMLEditType }
  ...
  IXMLEditType = interface(IXMLNode)
    ['{6182E191-C965-49F5-9A04-6C6EC3965611}']
    { Property Accessors }
    function Get_Href: UnicodeString;
    procedure Set_Href(Value: UnicodeString);
    { Methods & Properties }
...
{ IXMLAvatarType }
  ...
  IXMLAvatarType = interface(IXMLNode)
    ['{09832AD7-835E-46D5-80F6-23D99F0BCF79}']
    { Property Accessors }
    function Get_Href: UnicodeString;
    procedure Set_Href(Value: UnicodeString);
    { Methods & Properties }
